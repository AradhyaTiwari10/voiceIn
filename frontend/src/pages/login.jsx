  ...
  return (
    <div className="auth-page">
      <nav className="auth-navbar">
        ...
        <Link to={`${(import.meta.env.VITE_API_URL || "http://localhost:5001/api").replace(/\/$/, "")}/auth/linkedin`} className="btn-nav-login">Connect</Link>
      </nav>
        ...
        <div className="auth-content">
          ...
          <div className="text-column">
            ...
            <button
              ...
              onClick={() => window.location.href = `${(import.meta.env.VITE_API_URL || "http://localhost:5001/api").replace(/\/$/, "")}/auth/linkedin`}
            >
